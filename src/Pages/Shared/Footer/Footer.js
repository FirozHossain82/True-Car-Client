    ...
    <div className="grid grid-flow-col gap-4">
      ...
      <a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
       ...
       <div>
         ...
         <a href="/" className="link link-hover">Sell Microbus</a>
         <a href="/" className="link link-hover">Sell ElectricCar</a>
         <a href="/" className="link link-hover">Sell Luxurious-Car</a>
       </div>
       <div>
         <span className="footer-title  font-bold text-xl mb-3">True-Car</span>
         <a href="/" className="link link-hover">About us</a>
         <a href="/" className="link link-hover">Contact</a>
         <a href="/" className="link link-hover">Discount Policy</a>
       </div>
       <div>
